// Test minimal referral contract compilation
require('dotenv').config();
const { ethers } = require("hardhat");

async function main() {
  console.log("🔍 Testing minimal referral contract...");
  
  try {
    const Contract = await ethers.getContractFactory("TestReferral");
    
    console.log("📋 TestReferral ABI functions:");
